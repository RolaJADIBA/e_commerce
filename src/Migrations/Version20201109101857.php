 ...
 */
final class Version20201109101857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tailles (id INT AUTO_INCREMENT NOT NULL, options_id INT DEFAULT NULL, nom JSON NOT NULL, INDEX IDX_337A271E3ADB05F1 (options_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
