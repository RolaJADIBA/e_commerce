 ...
 */
final class Version20201111093457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tailles (id INT AUTO_INCREMENT NOT NULL, options_id INT DEFAULT NULL, nom VARCHAR(50) DEFAULT NULL, INDEX IDX_337A271E3ADB05F1 (options_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produits ADD tailles JSON DEFAULT NULL, DROP tailles_id');
    }
}
